...
public class StaticResources {
    ...
    public void images(RoutingContext rc) {
        ...
        StaticHandler staticHandler = StaticHandler.create(FileSystemAccess.ROOT, rootPath + "/images").setCachingEnabled(false)
    ...
    public void mods(RoutingContext rc) {
        //Log.info("STATIC RESOURCES" + rc.request().path());
        StaticHandler staticHandler = StaticHandler.create(FileSystemAccess.ROOT, library.modsPath().toString())
